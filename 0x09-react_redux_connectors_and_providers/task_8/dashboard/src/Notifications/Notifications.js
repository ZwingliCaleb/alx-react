                  ...
                  <ul style={{ padding: 0 }}> 
                    {this.props.listNotifications.map((notification) => (
                      <NotificationItem
                        ...
                        markAsRead={() => this.markAsReadHandler(notification.id)}
                        id={notification.id}
                      />
                    ))}
                  </ul>
                  <div style={{ marginTop: '10px' }}>
                    <button onClick={() => this.props.setNotificationFilter('URGENT')}>
                      ‼️ Set URGENT Filter
                    </button>
                    <button onClick={() => this.props.setNotificationFilter('DEFAULT')}>
                      💠 Set DEFAULT Filter
                    </button>
                  </div>
                </>
